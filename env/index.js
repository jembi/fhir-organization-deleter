...
if (!process.env.END_DATE) process.env.END_DATE = '2025-04-28 04:49:59';
if (!process.env.START_DATE) process.env.START_DATE = '2025-04-28 04:49:00';
...
if (!process.env.FILTER_HAPI_FHIR) process.env.FILTER_HAPI_FHIR = 'false';
